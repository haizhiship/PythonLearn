...
###周期性分析###
power = pd.read_csv('E:/LessonData/Ele_pow.csv', index_col=0)
print(power.head())
power.plot()
...
inputfile = 'E:/LessonData/missing_data.xls'  # 输入数据路径,需要使用Excel格式；
outputfile = 'E:/LessonData/missing_data_processed.xls'  # 输出数据路径,需要使用Excel格式
...
datafile = 'E:/LessonData/model.xls'  # 数据名
...
treefile = 'E:/LessonData/tree.pkl'  # 模型输出名字
...
datafile = 'E:/LessonData/model.xls'
...
netfile = 'E:/LessonData/net.model'  # 构建的神经网络模型存储路径
